...
class BookTest {
    public static void main(String[] args) {
        Book book1 = new Book("War and Peace", 1867, "Leo Tolstoi", 1225, 4.5, 234, "russian", 234234576, "Esmo", "A3");
        Book book2 = new Book("Pride and Prejudice", 1813, "Jane Austen", 432, 4.7, 23, "english", 2345767, "Esmo", "A2");
        Book book3 = new Book("Divine Comedy", 1321, "Dante Alighieri", 712, 4.5, 45, "italian", 3543578, "World", "A4");

        Book book4 = new Book("Book about something4", 1815, "Author unknown", 4352, 3.0, 23, "english", 23445767, "Esmo", "A2");
        Book book5 = new Book("Book about something5", 1675, "Author unknown", 4382, 4.3, 23, "english", 23457667, "Esmo", "A2");
        Book book6 = new Book("Book about something6", 1900, "Author unknown", 4332, 2.5, 45, "english", 23457767, "Esmo", "A2");
        Book book7 = new Book("Book about something7", 2001, "Author unknown", 4352, 2.4, 78, "english", 23455767, "Esmo", "A2");
        Book book8 = new Book("Book about something8", 2001, "Author unknown", 4321, 4.7, 79, "english", 23745767, "Esmo", "A2");
        Book book9 = new Book("Book about something9", 2002, "Author unknown", 4322, 4.7, 80, "english", 23457967, "Esmo", "A2");
